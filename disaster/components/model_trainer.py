...
from disaster.entity.config_entity import ModelTrainerConfig
from disaster.entity.artifact_entity import ModelTrainerArtifacts,DataTransformationArtifacts
...
class ModelTrainer:
    ...
    def splitting_data(self,csv_path):
        try:
            ...
            logging.info("Exiting data splitting function")
